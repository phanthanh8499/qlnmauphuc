...
function DetailForm(props) {
  ...
  const handleSubmit = () => {
    ...
    formData.append("product_old_name", data.product_name);
    formData.append("product_old_price", data.product_price);
    formData.append("product_old_typeid", data.product_typeid);
    formData.append("product_old_size", data.product_size);
    formData.append("product_old_color", data.product_color);
    formData.append("product_old_material", data.product_material);
    formData.append("product_old_lining", data.product_lining);
    formData.append("product_old_thickness", data.product_thickness);
    formData.append("product_old_softness", data.product_softness);
    formData.append("product_old_elasticity", data.product_elasticity);
    formData.append("product_old_introduction1", data.product_introduction1);
    formData.append("product_old_introduction2", data.product_introduction2);
    formData.append("product_old_introduction3", data.product_introduction3);
    formData.append("product_old_introduction4", data.product_introduction4);
    formData.append("product_old_introduction5", data.product_introduction5);
    
    const now = new Date();
    formData.append("log_date", format(now, "yyyy-MM-dd HH:mm:ss"));
    formData.append("log_userid", userInfo.id);
    formData.append("log_eventtypeid", 'EPF');
